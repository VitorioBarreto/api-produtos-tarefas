...
public class ProductNotFoundException extends RuntimeException { // 2. Estende RuntimeException

    public ProductNotFoundException(String message) { // 3. Construtor que aceita uma mensagem
